...
export const options = {
  // 预热阶段和负载阶段
  stages: [
    { duration: '5s', target: 100 },    // 预热：逐渐增加到100个虚拟用户
    { duration: '10s', target: 500 },   // 增加负载：在10秒内增加到500个虚拟用户
    { duration: '15s', target: 1000 },  // 增加负载：在15秒内增加到1000个虚拟用户
    { duration: '30s', target: 1000 },  // 稳定负载：保持1000个虚拟用户30秒
    { duration: '5s', target: 0 },      // 冷却：逐渐减少到0个虚拟用户
  ],
  thresholds: {
...
export default function() {
  ...
  sleep(Math.random() * 0.3); // 减少延迟以增加负载
}
