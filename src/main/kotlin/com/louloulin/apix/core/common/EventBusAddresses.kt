...
object EventBusAddresses {
    ...
    // 边缘控制中心相关
    const val EDGE_CONTROL_STATUS_GET = "apix.edge.control.status.get"
    const val EDGE_NODES_GET = "apix.edge.nodes.get"
    const val EDGE_NODE_DETAILS_GET = "apix.edge.node.details.get"
    const val EDGE_NODE_ADD = "apix.edge.node.add"
    const val EDGE_NODE_UPDATE = "apix.edge.node.update"
    const val EDGE_NODE_DELETE = "apix.edge.node.delete"
    const val EDGE_NODES_BATCH_OPERATE = "apix.edge.nodes.batch.operate"
    const val EDGE_NODE_GROUPS_GET = "apix.edge.node.groups.get"
    const val EDGE_NODE_GROUP_CREATE = "apix.edge.node.group.create"
    const val EDGE_NODE_GROUP_UPDATE = "apix.edge.node.group.update"
    const val EDGE_NODE_GROUP_DELETE = "apix.edge.node.group.delete"
    const val EDGE_NODE_METRICS_GET = "apix.edge.node.metrics.get"
    const val EDGE_NODE_ALERTS_GET = "apix.edge.node.alerts.get"
    const val EDGE_ALERT_RULE_CREATE = "apix.edge.alert.rule.create"
    const val EDGE_ALERT_RULE_UPDATE = "apix.edge.alert.rule.update"
    const val EDGE_ALERT_RULE_DELETE = "apix.edge.alert.rule.delete"
    const val EDGE_NODE_DIAGNOSE = "apix.edge.node.diagnose"
    const val EDGE_NODE_UPDATE_SOFTWARE = "apix.edge.node.update.software"
    const val EDGE_USERS_GET = "apix.edge.users.get"
    const val EDGE_USER_CREATE = "apix.edge.user.create"
    const val EDGE_USER_UPDATE = "apix.edge.user.update"
    const val EDGE_USER_DELETE = "apix.edge.user.delete"
    const val EDGE_ROLES_GET = "apix.edge.roles.get"
    const val EDGE_ROLE_CREATE = "apix.edge.role.create"
    const val EDGE_ROLE_UPDATE = "apix.edge.role.update"
    const val EDGE_ROLE_DELETE = "apix.edge.role.delete"
    const val EDGE_AUDIT_LOGS_GET = "apix.edge.audit.logs.get"
