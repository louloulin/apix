        ...
        return JsonObject()
            .put("jvm", JsonObject()
                ...
                .put("heapMemory", JsonObject()
                    .put("init", memoryMXBean.heapMemoryUsage.init)
                    .put("used", memoryMXBean.heapMemoryUsage.used)
                    .put("committed", memoryMXBean.heapMemoryUsage.committed)
                    .put("max", memoryMXBean.heapMemoryUsage.max)
                )
                .put("nonHeapMemory", JsonObject()
                    .put("init", memoryMXBean.nonHeapMemoryUsage.init)
                    .put("used", memoryMXBean.nonHeapMemoryUsage.used)
                    .put("committed", memoryMXBean.nonHeapMemoryUsage.committed)
                    .put("max", memoryMXBean.nonHeapMemoryUsage.max)
                )
