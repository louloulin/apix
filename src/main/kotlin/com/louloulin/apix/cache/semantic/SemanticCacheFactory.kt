...
object SemanticCacheFactory {
    ...
    fun createSemanticCache(
        ...
        return SemanticCacheManager(vertx, embeddingEngine, underlyingCache, similarityThreshold)
    }
    ...
    fun createFromConfig(vertx: Vertx, config: JsonObject): SemanticCacheManager {
        ...
        return createSemanticCache(vertx, embeddingEngine, underlyingCache, similarityThreshold)
    }
}
